...
def test_wheel_tag_accepts_exact_and_dotted_base() -> None:
    assert preflight.wheel_tag_ok("bench_v1", "bench_v1")
    assert preflight.wheel_tag_ok("bench_v1.0.1", "bench_v1")
    assert preflight.wheel_tag_ok("bench_v1.0.2", "bench_v1")


def test_wheel_tag_rejects_other_lines_and_missing() -> None:
    assert not preflight.wheel_tag_ok("bench_v1.0.1", "bench_v2")
    ...
    assert not preflight.wheel_tag_ok("bench_v1.0.2", "bench_v1.0.1")
