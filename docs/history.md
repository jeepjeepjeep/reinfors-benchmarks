...
> Preserved lab notebook of the benchmark campaign — including retained retractions and
> corrections. The current protocol, results, and interpretation live in the reinfors
> documentation (`docs/benchmarks/`); nothing published rests on a retracted number here.
